...
namespace LoggerDeviceValues
{
    ...
    {
        public List<LabDevice> Devices = new List<LabDevice>();
        ...
        public bool ConnectToDeviceThroughInterface(string _Interface, string _Device)
        {
            if (_Interface.Contains("Virtual"))
            {
                Devices.Add(new LabDevice(LabDevice.SupportedDevices.Virtual, LabDevice.DataTypes.Abstract));
            }
